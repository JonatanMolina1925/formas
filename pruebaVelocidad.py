...
for j in frecuencia:
    ...
    x10db = np.loadtxt(j+'/ConRuido/10db/'+perturbacion, delimiter=',')
    x20db = np.loadtxt(j+'/ConRuido/20db/'+perturbacion, delimiter=',')
    x30db = np.loadtxt(j+'/ConRuido/30db/'+perturbacion, delimiter=',')
    print("Prueba de" +perturbacion+ " a "+j+" kHz\n")
