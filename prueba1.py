...
#señal senoidal 
x = np.loadtxt('3200/SinRuido/flicker.csv', delimiter=',')
x10db = np.loadtxt('3200/ConRuido/10db/flicker.csv', delimiter=',')
x20db = np.loadtxt('3200/ConRuido/20db/flicker.csv', delimiter=',')
x30db = np.loadtxt('3200/ConRuido/30db/flicker.csv', delimiter=',')
...
plt.subplot(6,2,1), plt.plot(x)
plt.subplot(6,2,2), plt.plot(cA)
plt.subplot(6,2,3), plt.plot(CD1)
plt.subplot(6,2,4), plt.plot(CD2)
plt.subplot(6,2,5), plt.plot(CD3)
plt.subplot(6,2,6), plt.plot(CD4)
